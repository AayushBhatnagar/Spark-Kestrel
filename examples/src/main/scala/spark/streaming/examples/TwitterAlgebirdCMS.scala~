...
object TwitterAlgebirdCMS {
  def main(args: Array[String]) {
   ...
   System.setProperty("twitter4j.oauth.consumerKey", "WFpKfkM9DZyA9WbUxlRvg")
   System.setProperty("twitter4j.oauth.consumerSecret", "4ADs7bPYBmQ28eDxpeWAZgAkMNT0t3V3sNuB0h4Mny4")
   System.setProperty("twitter4j.oauth.accessToken", "60585063-8nXCy2GwcevuDl4p8RhS8gYdvdAxTVb0ejKDXGz3F")
   System.setProperty("twitter4j.oauth.accessTokenSecret", "L9ZgrqhHMpEv6fOZzKSKF9aMOn5kUk2kmgN2i6fRs")
